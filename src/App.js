...
export default class Profile extends React.Component {
  ...
  /* this.showHide = this.showHide.bind(this);
   showHide(){this.setState(state =>({show:!state.show}))}
    <button onClick={this.showHide} ></button>
 */
  ...
  render() {
    return (
      <div >
      <button style={{marginTop:"55px",backgroundColor:"#C1F4F0",fontSize:"large",fontWeight:"bold",marginLeft:"43%"}} onClick={()=>this.setState({show:!this.state.show}) } >Take a look at my profile</button>
      <br/>
      <br/>
